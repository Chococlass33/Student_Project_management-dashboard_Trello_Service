            ...
            return (
                <div>
                    ...
                    <p>
                        ...
                        <b>URL: </b> <a href={this.state.board.shortLink}>{this.state.board.shortLink}</a><br/>
                    </p>
                    <h2>Members</h2>
