    ...
    if (values.integrationId === undefined && values.projectId !== undefined) {
        ...
        return (
            <div>
                ...
                <p>
                    <a href={`http://167.99.7.70:3002/Actions?integrationId=${values.integrationId}`}>View Actions</a><br/>
                    <a href={`http://167.99.7.70:3002/Board?integrationId=${values.integrationId}`}>View Board</a>
                </p>
