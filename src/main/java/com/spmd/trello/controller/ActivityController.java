...
import com.spmd.trello.database.MemberRepository;
...
public class ActivityController
{
    ...
    ActivityController(ActionRepository repository, MemberRepository memrepository) {
        this.actionRepository = repository;
        this.memberRepository = memrepository;
    }

    @GetMapping("/activity")
    ResponseEntity<List<Lastmodified>> boardHistory(@RequestParam String emails, @RequestParam String boardIds) {
        ...
        HashMap<String, Timestamp> emailMap = new HashMap<String, Timestamp>();
    ...
    private static class Lastmodified
    {
        public String email;
        public String date;
        public Lastmodified(String email, String date) {this.email = email; this.date = date;}
